...
const commandsApiManagerDiscord = {
...
function updateCommandsRequest(route, commandsCollection) {

    const jsonDataCommands = commandsCollection.map(command => commandDataFormatter(command));
...
export default {commandsManagerDiscord: commandsApiManagerDiscord};